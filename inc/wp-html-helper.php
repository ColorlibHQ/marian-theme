...
// image default alt
if ( ! function_exists( 'marian_img_default_alt' ) ) {
	function marian_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'marian_img_tag' ) ) {
	function marian_img_tag( array $args ) {
		...
		if ( ! empty( $args['alt'] ) ) {
			...
			$alt = marian_img_default_alt( $url );
		}
...
// Anchor Tag
if ( ! function_exists( 'marian_anchor_tag' ) ) {
	function marian_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'marian_heading_tag' ) ) {
	function marian_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'marian_paragraph_tag' ) ) {
	function marian_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'marian_other_tag' ) ) {
	function marian_other_tag( array $args ) {
...
// Button Element 
if ( ! function_exists( 'marian_button_element ' ) ) {
	function marian_button_element( array $args ) {
